...
describe('Documentation', function () {
    test('can access all routes', function (string $route) {
        ...
        fn () => route('documentation', ['form', 'upload-async']),
        ...
        fn () => route('documentation', ['ui', 'chart']),
        ...
        fn () => route('documentation', ['ui', 'qr-code']),
        ...
        fn () => route('documentation', ['ui', 'spinner']),
        fn () => route('documentation', ['ui', 'stats']),
        fn () => route('documentation', ['ui', 'step']),
        fn () => route('documentation', ['ui', 'swap']),
