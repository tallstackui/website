...
>
    <head>
        ...
        <title>
            TallStackUI: Beautifully crafted components for your next TALL Stack
            idea
        </title>

        <meta
            name="description"
            content="TallStackUI gives you 80+ Blade components for Laravel, Livewire, Alpine.js, and Tailwind CSS. Free, open source, and ready to use."
        />
        ...
        <meta
            property="og:title"
            content="TallStackUI: Beautifully crafted components for your next TALL Stack idea"
        />
        <meta
            property="og:image"
            content="{{ asset("assets/images/og.png") }}"
