...
<x-layout :$content ai="dialog">
    ...
    <x-slot:description>Dialog component.</x-slot:description>
    ...
    <x-section title="JavaScript API" description="JavaScript API to interact with Dialog.">
        <div class="space-y-4">
            ...
            <x-warning> The dialog hooks are unavailable in the JavaScript API. </x-warning>
        </div>
    </x-section>
    <x-section title="Display After Redirects">
        <div class="space-y-4">
            ...
            <p>
                When using <x-block>flash()</x-block> method, the dialog will not be displayed in the current request,
    ...
    <x-section title="Colorful" disable-copy>
        <p>
            You can invert the Dialog colors using the <x-block>colorful</x-block> global so the body background takes
