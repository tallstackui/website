...
<x-layout :$content ai="rating">
    ...
    <x-section title="Concept" disable-copy>
        <p>
            In the modern world, many applications need to collect their user's
            level of satisfaction related to specific parts of a process, such
            as the purchase process, which may require the evaluation of service
            and even satisfaction with the delivery of the object. The rating
            component was created thinking precisely about serving this purpose,
            displaying stars to be clicked to evaluate something.
        </p>
    </x-section>
    <x-section title="Persist Rating" disable-copy>
        <p>
            The logic for persisting the rating in a database, such as SQL,
            SQLite or Redis (cache) is up to its own algorithm. When a star is
            pressed, the
