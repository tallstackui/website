...
<x-layout :$content ai="link">
    ...
    <x-section title="Size Variations">
        <x-preview language="blade" :contents="$sizes">
            <x-link :href="route('documentation', ['ui', 'link'])" text="TallStackUI" xs />
    ...
    <x-section title="Target Blank & Style Options">
        <x-preview language="blade" :contents="$blankBoldUnderline">
            <div class="flex items-center gap-x-2">
                ...
                <x-link :href="route('documentation', ['ui', 'link'])" text="TallStackUI" italic />
            </div>
        </x-preview>
    </x-section>
    <x-section
    ...
    <x-section title="Color Variations">
        <x-preview language="blade" :contents="$colors">
            <div class="flex flex-col gap-x-2">
                ...
                <x-link :href="route('documentation', ['ui', 'link'])" text="Mauve" color="mauve" />
                <x-link :href="route('documentation', ['ui', 'link'])" text="Olive" color="olive" />
                <x-link :href="route('documentation', ['ui', 'link'])" text="Mist" color="mist" />
                <x-link :href="route('documentation', ['ui', 'link'])" text="Taupe" color="taupe" />
