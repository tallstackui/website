...
<x-layout :$content ai="signature">
    ...
    <x-section title="Basic Usage">
        ...
        <x-warning class="mt-4">
            The signature component can only be used inside a Livewire
            component.
        </x-warning>
    </x-section>
    ...
    >
        ...
        <x-warning class="mt-4">
            Strokes are stored as points and redrawn when the width changes.
            This keeps the signature sharp because no image resampling occurs.
            However, the drawing scales only horizontally, which may change its
            proportions.
        </x-warning>
    </x-section>
</x-layout>
