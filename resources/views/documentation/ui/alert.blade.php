...
<x-layout :$content ai="alert">
    ...
    <x-slot:description>Alert components.</x-slot>
    ...
    <x-section
        title="Shadowless"
        description="An option to remove the shadow when using light variation."
    >
        <x-preview language="blade" :contents="$shadowless">
            <div class="space-y-2">
                <x-alert
                    title="TallStackUI"
                    text="Light, with the shadow it ships with"
                    light
                />
                <x-alert
                    title="TallStackUI"
    ...
    <x-section title="Side Border">
        <div class="space-y-4">
            ...
            <p>
                ...
                to inherit the alert's
                <x-block>color</x-block>
                , or
                <x-block>"&lt;side&gt;:&lt;color&gt;"</x-block>
                (e.g.,
                <x-block>"left:red"</x-block>
                ) to pin an explicit color independent from the rest of the
                alert. All 28 colors are supported.
            </p>
        </div>
    </x-section>
</x-layout>
