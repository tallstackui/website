...
<x-layout :$content ai="carousel">
    ...
    <x-slot:description>Carousel component.</x-slot:description>
    ...
    <x-section title="Clickable Caption" description="An option to display a title and description in the lightbox.">
        <div class="space-y-4">
            ...
            <p>
                You can also set <x-block>caption="footer"</x-block> to display the title and description out of the
                image.
            </p>
    ...
    <x-section
        ...
        description="An option to browse the gallery from inside the lightbox. Adds prev/next buttons on the sides of the lightbox and listens for the ←/→ keyboard arrows. When the lightbox closes, the main carousel advances to whichever image was last viewed."
    >
        <div class="space-y-4">
            ...
            <x-warning> The <x-block>navigable</x-block> prop requires <x-block>clickable</x-block>. </x-warning>
        </div>
    </x-section>
