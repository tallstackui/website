...
<x-layout :$content ai="slide">
    <x-slot:title>Slide</x-slot>
    <x-slot:description>Slide component.</x-slot>
        ...
        <x-preview language="blade" :contents="$persistent">
            <x-slide id="persistent-slide" title="TallStackUI" persistent>
                ...
                <x-slot:footer end>
                    <x-button
                        color="red"
                        x-on:click="$tsui.slide.close('persistent-slide')"
                    >
                        Close
                    </x-button>
                </x-slot>
    ...
    <x-section
        class="mt-4"
        title="Wireable"
        description="An option to control the slide via Livewire."
    >
