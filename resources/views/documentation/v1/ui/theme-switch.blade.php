...
<x-layout :$content>
    ...
    <x-section title="Concept" anchor="static-concept" disable-copy>
        <p>
            As TallStackUI offers <a href="{{ route('documentation', ['v1', 'helpers', 'dark-theme']) }}" wire:navigate class="underline">a helper
        ...
        <x-warning class="mt-2">
            You should only use this component if are using the <a href="{{ route('documentation', ['v1', 'helpers', 'dark-theme']) }}" wire:navigate class="underline">dark theme helper.</a>
        </x-warning>
    </x-section>
