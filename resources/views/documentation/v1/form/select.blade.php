...
<x-layout :$content>
    ...
    <x-slot:personalization>
        <livewire:personalization :personalization="$personalizationNative" component="Form\Select\Native" />
        <livewire:personalization :personalization="$personalizationStyled" component="Form\Select\Styled" />
    </x-slot:personalization>
