...
<x-layout :$content>
    ...
    <x-section title="The 4.x Palette" new disable-copy>
        <div class="space-y-4">
            <p>
                ...
                color pitched to applications as the second brand color. Overriding it therefore repainted text,
                borders and dividers across the library. Two changes untangle it.
            </p>
    ...
    <x-section title="Change the Default Namespace" disable-copy>
        <p>
            <a href="{{ route('documentation', ['configuration']) }}" wire:navigate class="underline">When you publish the configuration file</a>, you can change the default namespace for the color classes.
