            ...
            <div class="pl-4 space-y-4">
                <div>
                    ...
                    <ul>
                        ...
                        <li>- <a href="{{ route('documentation', ['ui', 'swap']) }}" wire:navigate class="underline">Swap</a>: a compact value cycler driven by buttons, drag or the keyboard.</li>
                        ...
                        <li>- <a href="{{ route('documentation', ['form', 'upload-async']) }}" wire:navigate class="underline">Upload Async</a>: chunked uploads straight to your own controller, so a file no longer has to fit inside the PHP request limits.</li>
                    </ul>
                </div>
                <div>
