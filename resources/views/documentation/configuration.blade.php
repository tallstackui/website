...
<x-layout :$content>
    ...
    <x-section title="Configuration File Structure" disable-copy>
        <div class="space-y-4">
            <p>
                The configuration file has a significantly large structure for configuring all aspects of TallStackUI in
                relation to the various available features. It presents a flat array of components, where each component
                is mapped to its class, and some components include arrays of embedded settings for per-component
                configuration (such as z-index, blur, overflow, and other default values). This approach offers granular
                control over the behavior of each component directly from the configuration file.
            </p>
            <p>
                ...
                release this documentation runs on the current version you're viewing.
            </p>
            <x-code language="php" :contents="tallstackui_configuration()" disable-copy/>
        </div>
    </x-section>
</x-layout>
