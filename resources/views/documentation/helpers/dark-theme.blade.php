...
<x-layout :$content>
    ...
    <x-section disable-copy>
        <div class="space-y-4">
            ...
            <p>
                This button must be covered by the layout that received the helper. If you prefer, <a href="{{ route('documentation', ['ui', 'theme-switch']) }}" wire:navigate class="underline">TallStackUI offer the Theme Switch component</a> to easily manage the dark theme.
            </p>
