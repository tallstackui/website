...
<x-layout :$content ai="form/password">
    <x-slot:title>Form Password</x-slot>
    <x-slot:description>
    ...
    <x-section
        ...
        description="An option to control the caps lock indicator."
    >
        <div class="space-y-4">
    ...
    >
        <div class="space-y-4">
            ...
            <p>
                ...
                attribute to use the default rules that come from the
                <x-refer doc="configuration">configuration file.</x-refer>
            </p>
            <x-code
                language="blade"
                :contents="$formatValidatorWithoutRules"
            />
        </div>
    </x-section>
    <x-section title="Password Generator">
        <div class="space-y-4">
            ...
            <p>
                ...
                attribute to use the default rules that come from the
                <x-refer doc="configuration">configuration file.</x-refer>
                With this approach all default rules will be applied to the
                password generator, which is better for enforcing a strong
                password.
            </p>
            <x-code
                language="blade"
                :contents="$passwordGeneratorWithoutRules"
            />
        </div>
    </x-section>
    <x-section title="Generator Algorithm" disable-copy>
        <div class="space-y-4">
            <p>
                The password generation algorithm was created with advanced
                techniques for generating unique passwords. The algorithm is
                good and functional, but if for some reason you want to change
                it, you can define your own password generation algorithm:
            </p>
            <p>
            ...
            <p>
                ...
                ,
                <x-block>numbers</x-block>
                , and
                <x-block>symbols</x-block>
                are boolean variables that will have their true values when the
                user passes the rule to the component. The
                <x-block>min</x-block>
