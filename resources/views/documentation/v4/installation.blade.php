<x-layout :$content>
    ...
    <x-section class="mt-4" title="Meet TallStackUI" disable-copy>
        TallStackUI is <b class="text-pink-600">a powerful suite of 50+ ready-to-use components for TALL Stack applications.</b>
    ...
    <x-section title="Starter Kit" disable-copy>
        ...
        on a new project creation. <a href="{{ route('documentation', ['v4', 'starter-kit']) }}" class="underline" wire:navigate>Click here!</a>
    </x-section>
