...
<x-layout :$content :ai="['Layout' => 'layout/main', 'Layout Header' => 'layout/header', 'Sidebar' => 'layout/sidebar/main', 'Sidebar Item' => 'layout/sidebar/item', 'Sidebar Separator' => 'layout/sidebar/separator']">
    <x-slot:title>
        Layout
    </x-slot:title>
    <x-slot:description>
    ...
    <x-section title="Customization" disable-copy>
        ...
        <a href="{{ route('documentation', ['v4', 'customization', 'concept']) }}" wire:navigate class="underline">soft customization or deep customization.</a>
    </x-section>
</x-layout>
