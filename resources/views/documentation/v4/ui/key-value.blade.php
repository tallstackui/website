...
<x-layout :$content ai="key-value">
    ...
    <x-section title="Label & Value" description="An option to customize the headers of the component.">
        <div class="space-y-4">
            ...
            <p>
                You can customize all translations of the component by <a href="{{ route('documentation', ['v4', 'translation']) }}" class="underline" wire:navigate>publishing the translations files.</a>
            </p>
        </div>
    </x-section>
