...
<x-layout :$content ai="command-palette">
    ...
    <x-section title="Keyboard Shortcut" disable-copy>
        <div class="space-y-4">
            <p>
                ...
                <a href="{{ route('documentation', ['v4', 'configuration']) }}" wire:navigate class="underline">configuration file</a>
    ...
    <x-section title="Recycle" disable-copy>
        <div class="space-y-4">
            ...
            <p>
                You can also control it globally in the <a href="{{ route('documentation', ['v4', 'configuration']) }}" wire:navigate class="underline">configuration file.</a>
            </p>
        </div>
    </x-section>
    ...
    <x-section title="Actionable" disable-copy>
        <div class="space-y-4">
            <p>
                ...
                item selection in two other ways. You can configure an invocable PHP class in the <a href="{{ route('documentation', ['v4', 'configuration']) }}" wire:navigate class="underline">configuration file</a>
    ...
    <x-section title="Background Blur" disable-copy>
        ...
        exclusively via a <a href="{{ route('documentation', ['v4', 'configuration']) }}" wire:navigate class="underline">configuration file</a>,
    ...
    <x-section title="Mobile Centered" disable-copy>
        ...
        in the <a href="{{ route('documentation', ['v4', 'configuration']) }}" wire:navigate class="underline">configuration file</a> using the <x-block>centered</x-block> configuration.
    ...
    <x-section title="Overlay">
        <div class="space-y-4">
            ...
            <p>
                You can also flip the default globally in the <a href="{{ route('documentation', ['v4', 'configuration']) }}" wire:navigate class="underline">configuration file</a>
