...
<x-layout :$content :ai="['Dial' => 'dial/main', 'Dial Items' => 'dial/items']">
    ...
    <x-section title="Basic Usage">
        <x-preview language="blade" :contents="$basic" frame="ui/dial/basic" :height="380" />
    </x-section>
    ...
    <x-section title="Horizontal">
        <div class="space-y-4">
            ...
            <x-preview language="blade" :contents="$horizontal" frame="ui/dial/horizontal" :height="320" />
        </div>
    </x-section>
    ...
    <x-section title="Size Variations">
        <x-preview language="blade" :contents="$sizes" frame="ui/dial/sizes" :height="480" />
    </x-section>
