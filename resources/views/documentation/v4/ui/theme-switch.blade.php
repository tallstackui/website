...
<x-layout :$content ai="theme-switch">
    ...
    <x-warning class="mt-2">
        You should only use this component if are using the <a href="{{ route('documentation', ['v4', 'helpers', 'dark-theme']) }}" wire:navigate class="underline">dark theme helper.</a>
    </x-warning>
