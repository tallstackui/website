...
<x-layout :$content>
    ...
    <x-section title="Publishing Configuration File" disable-copy>
        <p>
            <a class="underline" href="{{ route('documentation', ['v4', 'configuration']) }}" wire:navigate>To start deep customization you must publish the TallStackUI configuration file.</a>
        </p>
    </x-section>
    <x-section title="Override Component Class" disable-copy>
        <div class="space-y-4">
            <p>
                As deep customization consists of having absolute control over the component, the idea behind
                this form of customization is to overwrite the original TallStackUI component class, which is
            ...
            <p class="my-2">
                Every component that can be customized has a method called <x-block>customization</x-block>, which is where the
                classes come from. This method must return an array with the name of the customization blocks and
                their respective values which must be the TailwindCSS classes to be applied. To learn about customization blocks,
                visit the documentation for the component you are customizing.
            </p>
            <x-warning>
                Even if you prefer to use deep customization,
                <a href="{{ route('documentation', ['v4', 'customization', 'soft']) }}" wire:navigate class="underline">soft customization</a> can still be applied to components.
            </x-warning>
        </div>
    </x-section>
    ...
    <x-section title="Publish Blade Files" disable-copy>
        <div class="space-y-4">
            ...
            <p>
                ...
                you to republish the Blade files and add your own customization.
            </p>
            <p>
