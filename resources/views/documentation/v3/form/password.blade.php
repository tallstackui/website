...
<x-layout :$content ai="form/password">
    ...
    <x-section title="Format Validator" description="An option to visually validate the format of the entered password.">
        <div class="space-y-4">
            ...
            <p>
                You can also omit the <x-block>rules</x-block> attribute to use the default rules that come from the <a href="{{ route('documentation', ['configuration'])  }}" class="underline" wire:navigate>configuration file.</a>
            </p>
    ...
    <x-section title="Password Generator">
        <div class="space-y-4">
            ...
            <p>
                ...
                to use the default rules that come from the <a href="{{ route('documentation', ['configuration']) }}" class="underline">configuration file.</a> With
