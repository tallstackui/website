    ...
    <x-section title="Invalidate" description="An option to not show validation error message.">
        <div class="space-y-4">
            ...
            <x-warning class="mt-4">
                ...
                globally by setting it via the <a href="{{ route('documentation', ['v3', 'configuration']) }}" class="underline" wire:navigate>configuration file.</a> This way, all components that can
