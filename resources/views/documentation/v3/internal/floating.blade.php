...
<x-layout :$content :torchlight="false">
    ...
    <x-section class="mt-4">
        ...
        <ul class="mt-2 list-decimal list-inside">
            ...
            <li><a href="{{ route('documentation', ['v3', 'form', 'upload']) }}" wire:navigate>Form Upload</a></li>
            <li><a href="{{ route('documentation', ['v3', 'form', 'color']) }}" wire:navigate>Form Color</a></li>
            <li><a href="{{ route('documentation', ['v3', 'ui', 'dropdown']) }}" wire:navigate>Dropdown</a></li>
            <li><a href="{{ route('documentation', ['v3', 'form', 'select']) }}" wire:navigate>Select</a></li>
        </ul>
    </x-section>
</x-layout>
