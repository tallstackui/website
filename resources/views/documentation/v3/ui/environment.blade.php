    ...
    <x-section title="Beyond Basic, EnvBar">
        <div class="space-y-4">
            <p>
                ...
                of version 2.x of TallStackUI a new helper was introduced: <a href="{{ route('documentation', ['v3', 'helpers', 'env-bar']) }}" wire:navigate class="underline">EnvBar</a>.</b> Unlike the environment component,
                ...
                and <a href="{{ route('documentation', ['v3', 'helpers', 'env-bar']) }}" class="underline">use the EnvBar click here.</a>
            </p>
