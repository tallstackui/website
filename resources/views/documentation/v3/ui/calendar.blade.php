...
<x-layout :$content ai="calendar">
    ...
    <x-section title="Basic Usage">
        <div class="space-y-4">
            <p>
                ...
                <x-block>&lt;x-date&gt;</x-block>, but rendered directly in the page with no input
    ...
    <x-section title="Double Mode" description="An option to render two months side-by-side. Useful for selecting ranges that span multiple months.">
    ...
    <x-section title="Lock Month Year" description="An option to disable the month/year header buttons. Day selection and prev/next month navigation continue to work.">
    ...
    <x-section title="Other Options">
        <p>
            In addition to the methods demonstrated above, all other methods available in the <a href="{{ route('documentation', ['v3', 'form', 'date']) }}" wire:navigate class="underline">date</a> component are also available in the Calendar component.
        </p>
    </x-section>
</x-layout>
