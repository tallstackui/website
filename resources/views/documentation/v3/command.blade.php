<x-layout :$content>
    ...
    <x-section title="Setup Colors" description="Command used to set up component colors." disable-copy>
        <div class="space-y-4">
            ...
            <p>
                This command is used to set up or manipulate component colors. <a href="{{ route('documentation', ['v2', 'personalization', 'color']).'#create-or-manipulate-colors' }}" class="underline" wire:navigate>Read more about it by clicking here.</a>
            </p>
        </div>
    </x-section>
