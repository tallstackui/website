                            ...
                            <header class="mb-6 space-y-1">
                                @if ($title)
                                    <div class="flex items-start gap-x-2">
                                        <h1 class="font-display dark:text-dark-50 text-3xl font-semibold tracking-tight text-gray-900">
                                            {{ $title }}
                                        </h1>
                                        @if ($version)
                                            <x-badge color="pink" light xs round> >= {!! $version !!} </x-badge>
                                        @endif
                                        @if ($ai)
                                ...
                                @endif
                                @if ($description)
                                    <p class="dark:text-dark-400 text-sm text-gray-500">{{ $description }}</p>
                                @endif
