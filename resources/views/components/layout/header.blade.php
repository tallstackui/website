<header
    class="top-0 z-50 flex flex-none flex-wrap items-center justify-between bg-white px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 dark:bg-transparent dark:shadow-none sm:px-6 lg:px-8">
    ...
    <div class="-my-5 mr-6 sm:mr-8 md:mr-0">
        <button type="button"
                class="flex h-6 w-6 items-center justify-center group sm:justify-start md:py-2.5 md:pr-3.5 md:h-auto md:w-80 md:flex-none md:rounded-lg md:pl-4 md:text-sm md:ring-1 md:ring-slate-200 lg:w-96 md:hover:ring-slate-300 dark:md:hover:bg-slate-700/40 dark:md:bg-slate-800/75 dark:md:ring-inset dark:md:hover:ring-slate-500 dark:md:ring-white/5">
