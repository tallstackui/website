<header
    class="dark:border-dark-700/60 dark:bg-dark-900/85 sticky top-0 z-40 border-b border-gray-200 bg-white/85 backdrop-blur-md"
>
    <div class="flex h-14 items-center gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3">
            ...
            <span
                class="hidden rounded-full border border-pink-500/30 bg-pink-500/10 px-2 py-0.5 font-mono text-[0.6rem] font-semibold tracking-[0.12em] text-pink-500 uppercase sm:inline-flex"
            >
                {{ $version }}
            </span>
        </div>
        ...
        <div class="ml-auto flex items-center gap-4">
            ...
            >
                ...
                <span class="flex-1 text-left text-[0.82rem]">
                    Search docs...
                </span>
                <span
