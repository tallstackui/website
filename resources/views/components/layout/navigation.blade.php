    ...
    <div class="mb-4 pr-4 sm:flex-1 sm:pr-0">
        <div class="bg-white dark:bg-slate-900 relative">
            <button type="button" 
                    ...
                    class="hidden w-full lg:flex items-center text-sm leading-6 text-slate-400 rounded-md ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-600 dark:bg-slate-800 dark:highlight-white/5 dark:hover:bg-slate-700">
