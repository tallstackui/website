<x-modal id="aj" center blur>
    <div class="relative -mt-2 px-1 py-2 sm:px-2">
        ...
        <div class="relative flex flex-col items-center text-center">
            ...
            <h2
                class="font-display dark:text-dark-100 mt-5 text-2xl font-semibold tracking-tight text-slate-900"
            >
                AJ Meireles
            </h2>
            <p
                class="mt-1 text-xs font-semibold tracking-[0.18em] text-pink-600 uppercase dark:text-pink-400"
            >
                Creator of TallStackUI
            </p>

            <p
                class="dark:text-dark-300 mt-4 max-w-lg text-sm leading-relaxed text-slate-600"
            >
                AJ is a full-stack developer with more than 10 years of
            ...
            <div class="grid gap-2 sm:grid-cols-2">
                ...
                >
                    <x-icon
                        name="document-text"
                        solid
                        class="h-4 w-4 transition group-hover:rotate-3"
                    />
                    AJ's CV
                </a>
            </div>
