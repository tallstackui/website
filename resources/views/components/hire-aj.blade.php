<x-modal id="aj" center blur>
    <div class="relative -mt-2 px-1 py-2 sm:px-2">
        <div aria-hidden="true"
             class="pointer-events-none absolute -top-12 left-1/2 h-40 w-72 -translate-x-1/2 bg-linear-to-tr from-pink-400/40 via-fuchsia-400/30 to-violet-400/40 blur-3xl dark:opacity-50"></div>

        <div class="relative flex flex-col items-center text-center">
            <div class="relative">
                <div aria-hidden="true"
                     class="absolute -inset-2.5 animate-pulse rounded-full bg-linear-to-tr from-pink-500 via-fuchsia-500 to-violet-500 opacity-60 blur-lg"></div>
        ...
        <div class="relative mt-6 space-y-2">
            <a href="mailto:alvinhooxd@gmail.com"
