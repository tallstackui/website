<section class="landing-section">
    <div class="landing-cta-final" data-reveal>
        ...
        <h2 class="landing-cta-final-headline mt-6">Ship something <span class="landing-serif">beautiful.</span></h2>
        ...
        <div class="mt-10 flex flex-wrap items-center justify-center gap-3">
            ...
            <button
                ...
                x-data="{ copied: false }"
                x-on:click="
                    $tsui.copy('composer require tallstackui/tallstackui').then(() => {
                        copied = true;
