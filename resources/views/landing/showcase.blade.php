<section
    id="showcase"
    class="landing-section landing-section--ruled scroll-mt-10"
>
        ...
        <div class="min-w-0 lg:col-span-5" data-reveal>
            <div class="lg:sticky lg:top-24">
                ...
                <h2 class="landing-section-heading mt-5">
                    Nothing here is a
                    <span class="landing-serif">screenshot.</span>
                </h2>
                <p class="landing-section-subheading mt-5">
                    The form on the right is a single Livewire component built
                    entirely from TallStackUI parts, with validation and
                    feedback wired in. The styled select hits a real endpoint
                    and the pin code actually checks what you type. Go ahead and
                    try to break it.
                </p>

                <ul
                    class="dark:text-dark-300 mt-8 space-y-3 text-sm text-gray-600"
                >
                    ...
                    <li class="flex items-start gap-2.5">
                        ...
                        />
                        Async
                        <code class="font-mono text-[0.85em] text-pink-500">
                            select.styled
                        </code>
