<section id="new" class="landing-section landing-section--ruled scroll-mt-10">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-6">
        <article
            ...
            class="landing-panel landing-panel--hover p-6 lg:col-span-4"
            data-reveal
        >
        ...
        <article
            x-data="spotlight"
            x-on:mousemove="move($event)"
            class="landing-panel landing-panel--hover p-6 lg:col-span-2"
            data-reveal
        ...
        <article
            x-data="spotlight"
            x-on:mousemove="move($event)"
            class="landing-panel landing-panel--hover p-6 lg:col-span-3"
            data-reveal
        >
            ...
            <div class="mt-6">
                <x-editor
                    name="landing_editor"
                    :toolbar="['style', 'bold', 'italic', 'underline', 'unordered-list', 'blockquote', 'link']"
                    min-height="11rem"
                    max-height="16rem"
                />
            </div>
