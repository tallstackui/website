    ...
    <div class="grid grid-cols-1 items-center gap-14 lg:grid-cols-12">
        <div class="min-w-0 lg:col-span-6">
            ...
            <h1 class="landing-headline landing-rise landing-rise--2 mt-6">
                Beautifully <span class="landing-serif landing-serif--upright">crafted</span> components for your next
                <span class="text-pink-500">TALL Stack</span> idea.
            </h1>

            <p class="landing-section-subheading landing-rise landing-rise--3 mt-6 text-[1.05rem]">
                TallStackUI gives you 80+ Blade components for Laravel, Livewire, Alpine.js, and Tailwind CSS.
                <span class="landing-mark">It's 100% free, open source, and there's no Pro tier hiding behind a paywall.</span>
            </p>

            <div class="landing-rise landing-rise--4 mt-9 flex flex-wrap items-center gap-3">
                <a href="{{ route('documentation', ['installation']) }}" wire:navigate class="landing-cta-primary">
                    Start building
        ...
        <div class="landing-rise landing-rise--5 min-w-0 lg:col-span-6">
                ...
                <div class="space-y-5 p-5 sm:p-6">
                    <div class="grid gap-4 sm:grid-cols-2">
                        <x-stats
                            ...
                            shadowless
                            bordered
                            :chart="collect(range(1, 8))->map(fn () => rand(6, 46))->all()"
                        />
                        <x-stats
                            :number="84"
                            title="Components"
                            ...
                            shadowless
                            bordered
                            :chart="collect(range(1, 8))->map(fn () => rand(10, 50))->all()"
                        />
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <x-select.styled
                            name="hero_stack"
                            label="Stack"
                            :options="['Livewire 4', 'Blade only']"
                            value="Livewire 4"
                        />
                    </div>

                    <div class="dark:border-dark-700 -mx-5 flex flex-wrap items-center justify-between gap-4 border-t border-gray-200 px-5 pt-5 sm:-mx-6 sm:px-6">
