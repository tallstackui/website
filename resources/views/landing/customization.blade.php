    ...
    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
        <div class="min-w-0 lg:col-span-5" data-reveal>
            ...
            <h2 class="landing-section-heading mt-5">
                Yours,
                <span class="landing-serif">all the way</span>
                down.
            </h2>
            ...
            <ul class="dark:text-dark-300 mt-6 space-y-3 text-sm text-gray-600">
                <li class="flex items-start gap-2.5">
                    ...
                    />
                    Every block is public API, and renames are documented
                    migrations.
                </li>
                <li class="flex items-start gap-2.5">
                    <x-icon
                        ...
                        class="mt-0.5 h-4 w-4 shrink-0 text-pink-500"
                    />
                    Chains stack: two providers layer on top of each other, not
                    over.
                </li>
                <li class="flex items-start gap-2.5">
                    <x-icon
                        ...
                        class="mt-0.5 h-4 w-4 shrink-0 text-pink-500"
                    />
                    Skeletons inherit it all, so placeholders match your look
                    for free.
                </li>
            </ul>
