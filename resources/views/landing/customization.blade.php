    ...
    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
        <div class="min-w-0 lg:col-span-5" data-reveal>
            ...
            <h2 class="landing-section-heading mt-5">
                Yours, <span class="landing-serif">all the way</span> down.
            </h2>
            <p class="landing-section-subheading mt-5">
                Soft customization lets you append, replace or remove any Tailwind class
                on any block of any component, straight from your
                <code class="font-mono text-[0.85em] text-pink-500">AppServiceProvider</code>
                and without forking a single template. Define scopes for opt-in variants,
                or extend the ones that already exist, including the scopes the package ships.
            </p>

            <ul class="mt-6 space-y-3 text-sm text-gray-600 dark:text-dark-300">
        ...
        <div class="min-w-0 lg:col-span-7" data-reveal style="--reveal-delay: 0.1s">
            <div class="landing-ide">
                ...
                <div class="flex min-h-72 sm:min-h-80">
                    <div class="shrink-0 select-none py-3.5 pl-3 pr-2 text-right font-mono text-[0.7rem] leading-[1.55] text-neutral-600 sm:py-4 sm:pl-4 sm:pr-3 sm:text-[0.8rem]" aria-hidden="true">
