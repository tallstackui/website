<section id="theme" class="landing-section landing-section--ruled scroll-mt-10">
    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
        ...
        <div class="min-w-0 lg:col-span-7" data-reveal style="--reveal-delay: 0.1s">
            <div class="landing-ladder shadow-[0_60px_120px_-60px_rgba(0,0,0,0.7)]">
                <div style="background: oklch(0.145 0 0)" class="landing-ladder-step">
                    <span><b>dark-900</b> · page background</span>
                    <span>oklch(0.145 0 0)</span>
                </div>
                <div style="background: oklch(0.185 0 0)" class="landing-ladder-step">
                    <span><b>dark-800</b> · component surfaces</span>
                    <span>oklch(0.185 0 0)</span>
                </div>
                <div style="background: oklch(0.253 0 0)" class="landing-ladder-step">
                    <span><b>dark-700</b> · borders, dividers, tracks</span>
                    <span>oklch(0.253 0 0)</span>
                </div>
                <div style="background: oklch(0.36 0 0)" class="landing-ladder-step">
                    <span><b>dark-600</b> · hover and raised states</span>
                    <span>oklch(0.36 0 0)</span>
                </div>
                <div class="landing-ladder-step" style="background: oklch(0.185 0 0)">
                    <span class="text-dark-400">Input borders sit at <b class="text-dark-100">dark-600/50</b>, softer than a solid line.</span>
                </div>
            </div>
        </div>
    </div>
