<x-demo-layout title="Layout Header Slots">
    <x-tsui-layout.header>
        <x-slot:left>
            <span class="text-sm font-semibold text-slate-700 dark:text-dark-200">Left slot</span>
        </x-slot:left>
        <x-slot:middle>
            <span class="text-sm text-slate-500 dark:text-dark-400">Middle slot</span>
        </x-slot:middle>
        <x-slot:right>
    ...
    <div class="px-6 py-8 text-sm text-slate-500 dark:text-dark-400">
