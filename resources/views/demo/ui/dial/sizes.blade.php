<x-demo-layout title="Dial Sizes">
    <div
        class="dark:text-dark-400 flex min-h-[440px] flex-col items-center justify-center px-6 py-10 text-sm text-slate-500"
    >
        <p class="text-center">
            Four size variations, one in each corner:
            <br />
            <b>xs</b>
            (top-left) ·
            <b>sm</b>
