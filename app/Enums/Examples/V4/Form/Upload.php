...
class Upload
{
    ...
    public const string ASYNC_BASIC = <<<'HTML'
    <x-upload.async wire:model="document" :route="route('uploads.store')" label="Document" />
    HTML;

    public const string ASYNC_MULTIPLE = <<<'HTML'
    ...
    public const string ASYNC_MANUAL = <<<'HTML'
    <x-upload.async wire:model="files" :route="route('uploads.store')" multiple manual />
    HTML;

    public const string ASYNC_NATIVE = <<<'HTML'
    ...
    public const string ASYNC_VALUE = <<<'PHP'
    [
        [
            'id' => '9f8c2b1e-...',
    ...
    public const string ASYNC_CONTROLLER = <<<'PHP'
    ...
    public const string ASYNC_STORE = <<<'PHP'
    return $this->upload($request, [
        'disk' => 'public',
    ...
    public const string ASYNC_CUSTOMIZATION = <<<'HTML'
