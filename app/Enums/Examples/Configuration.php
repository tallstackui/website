...
class Configuration
{
    ...
    public const string STRUCTURE = <<<'HTML'
    <?php
        ...
        */
        'components' => [
            ...
            'command-palette' => [
                ...
                |----------------------------------------------------------------------
                |
                | actionable: the callable class for handling item selection.
                ...
                | shortcut: keyboard shortcut to toggle the palette (e.g., 'ctrl.k').
            ...
            'dialog' => [
                ...
                | persistent: enables the dialog to not be closed by clicking outside.
                */
                [
                    'z-index' => 'z-50',
                    'overflow' => false,
            ...
            'icon' => [
                ...
                [
                    ...
                    |----------------------------------
                    | Allowed: heroicons, BladeUI or anonymous Blade components as svg.
                    */
                    ...
                    */
                    'custom' => [
                        ...
                        |----------------------------------
                        |
                        | These icons are used internally in the components. When using
                        | custom icons via BladeUI or local SVG files, you can change
                        | the internal icons to custom icons, causing this to reflect
                        | new icon looks for the internal components.
                        */
                        'guide' => [
                            'arrow-path' => null,
            ...
            'layout' => [
                ...
                |----------------------------------------------------------------------
                |
                | ignore: Controls the registration of the layout component and all
                | its children, useful for situations where you want to ignore these
                | components in favor of avoiding conflict with your layout component.
                */
                [
            ...
            'modal' => [
                ...
                [
                    ...
                    | overflow: avoids hiding the overflow, allowing the scroll of the page.
                    | blur: enables the background blur effect (Allowed: false, sm, md, lg, xl).
                    | persistent: enables the modal to not be closed by clicking outside.
            ...
            'select.styled' => [
                ...
                [
                    ...
                    |----------------------------------------------------------------------
                    | unfiltered: allow all select API-styled components to be unfiltered.
            ...
            'slide' => [
                ...
                [
                    ...
                    | overflow: avoids hiding the overflow, allowing the scroll of the page.
                    | blur: enables the background blur effect (Allowed: false, sm, md, lg, xl).
                    | persistent: enables the slide to not be closed by clicking outside.
